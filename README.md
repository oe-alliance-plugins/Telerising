...
# <p align="center">telerising Plugin for Enigma2 (E²) ![GitHub repo size](https://img.shields.io/github/repo-size/oe-alliance-plugins/telerising.svg)</p>

**Run Telerising locally on the receiver and import provider channels into
normal TV bouquets using native Enigma2 setup screens.**


## Github status
[![Build](https://github.com/oe-alliance-plugins/telerising/actions/workflows/buildbot.yml/badge.svg)](https://github.com/oe-alliance-plugins/telerising/actions/workflows/buildbot.yml)
[![Lint Status](https://github.com/oe-alliance-plugins/telerising/actions/workflows/pylint.yml/badge.svg)](https://github.com/oe-alliance-plugins/telerising/actions/workflows/pylint.yml)
[![Ruff Status](https://github.com/oe-alliance-plugins/telerising/actions/workflows/ruff.yml/badge.svg)](https://github.com/oe-alliance-plugins/telerising/actions/workflows/ruff.yml)
[![Build Status](https://github.com/oe-alliance-plugins/telerising/actions/workflows/compile.yml/badge.svg)](https://github.com/oe-alliance-plugins/telerising/actions/workflows/compile.yml)
[![AUTOTAG](https://github.com/oe-alliance-plugins/telerising/actions/workflows/autotag.yml/badge.svg)](https://github.com/oe-alliance-plugins/telerising/actions/workflows/autotag.yml)


[![Plugin Version](https://img.shields.io/github/v/tag/oe-alliance-plugins/telerising?label=Latest%20Version&color=darkviolet)](https://github.com/oe-alliance-plugins/telerising/tags)
[![Latest Release](https://img.shields.io/github/release-date/oe-alliance-plugins/telerising?label=From&color=darkviolet)](https://github.com/oe-alliance-plugins/telerising/releases/latest)
[![Github last commit](https://img.shields.io/github/last-commit/oe-alliance-plugins/telerising)](https://github.com/oe-alliance-plugins/telerising)
[![GitHub Activity](https://img.shields.io/github/commit-activity/y/oe-alliance-plugins/telerising.svg?label=commits)](https://github.com/oe-alliance-plugins/telerising/commits)
...
telerising is created by users for users and we welcome every contribution. There are no highly paid developers. There are only users who have seen a problem and done their best to fix it. This means telerising will always need the contributions of users like you. How can you get involved?
